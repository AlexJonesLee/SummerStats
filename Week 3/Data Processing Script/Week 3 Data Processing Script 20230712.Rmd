...
#Add split columns into the data frame
data<-cbind(data,conditionSplit)

#Removing the original condition column
data<-data[,-4]
...
#Save the data
write.csv(data,"Week 3/Processed Data/Week 3 PROCESSED.csv")
